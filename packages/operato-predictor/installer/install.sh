...
if [ -f "start.sh" ] ; then
  ...
  curl -O https://raw.githubusercontent.com/things-factory/things-factory/main/packages/operato-predictor/installer/start.sh
fi
...
if [ -f "stop.sh" ] ; then
  ...
  echo "stop.sh create"
  curl -O https://raw.githubusercontent.com/things-factory/things-factory/main/packages/operato-predictor/installer/stop.sh
fi
...
if [ -f "upgrade.sh" ] ; then
  ...
  curl -O https://raw.githubusercontent.com/things-factory/things-factory/main/packages/operato-predictor/installer/upgrade.sh
fi
...
if [ -f "migrate.sh" ] ; then
  ...
  curl -O https://raw.githubusercontent.com/things-factory/things-factory/main/packages/operato-predictor/installer/migrate.sh
fi
